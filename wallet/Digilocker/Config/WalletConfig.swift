...
enum WalletConfig {
    ...
    static let headerFontName = "SeasonSerif-Regular-TRIA"
    static let headerFontFileName = "Geist-regular"
    static let headerFontFileExtension = "otf"
    static let headerTopSpacing: CGFloat = 320
    ...
    static let subtitleColor = Color(red: 158/255, green: 158/255, blue: 158/255)
